...
public class PhysiqueActivity extends ListActivity
{
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case 0:
			...
			// TextView mTextView=
			// (TextView)this.findViewById(R.id.dialogContentTextview);
			// mTextView.setText(getText(R.string.dialogContent)+String.valueOf(sum));
			// Toast.makeText(this,
			// "rating:"+String.valueOf(sum),Toast.LENGTH_LONG).show();
			...
			mDialog.setOnCancelListener(new OnCancelListener()
			{
				...
				{
					// 按下ok按钮时
					healthInfo.setCorporeity(sum);
					intent.setClass(context, CollectMedicalHistory.class);
